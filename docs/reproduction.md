...
Install `code/requirements-dev.txt`. The console, API and comparisons use the
...
A failed calculation or numerical acceptance gate stops the sequence and records an incomplete run. Rerunning an
individual comparison replaces its generated outputs.
